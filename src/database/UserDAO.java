...
public class UserDAO {
	...
	public LinkedList<String> getUserCredentials(String usernameInput){
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Could not retrieve users credentials (2)");
			error.printStackTrace();
		}
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Could not retrieve users credentials (3)");
			error.printStackTrace();
		}
	...
	public LinkedList<String> getAllUsers() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Could not retrieve all users usernames (1)");
			error.printStackTrace();
		}
